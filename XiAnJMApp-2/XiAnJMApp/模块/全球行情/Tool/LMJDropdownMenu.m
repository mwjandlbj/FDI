...
//    _mainBtn.titleLabel.textAlignment = NSTextAlignmentCenter;
    ...
    _mainBtn.backgroundColor    = RGB(24,26,30);
    _mainBtn.layer.borderColor  = RGB(101,110,124).CGColor;
    ...
    // 旋转尖头
    _arrowMark = [[UIImageView alloc] initWithFrame:CGRectMake(_mainBtn.frame.size.width - 41, 0, 41, _mainBtn.frame.size.height)];
//    _arrowMark.backgroundColor = RGB(101,110,124);
    _arrowMark.center = CGPointMake(VIEW_CENTER_X(_arrowMark), VIEW_HEIGHT(_mainBtn)/2);
    _arrowMark.image  = [UIImage imageNamed:@"ic_down_but"];
...
- (void)showDropDown{   // 显示下拉列表
    ...
    [UIView animateWithDuration:AnimateTime animations:^{
        ...
        _tableView.frame = CGRectMake(0, 0, VIEW_WIDTH(_listView), VIEW_HEIGHT(_listView)/2);
